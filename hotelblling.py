...
menu_category = ["Tea & Coffee","Beverages","Fast Food","South Indian",
                 "Starters","Main Course","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Beverages":
    "2 Beverages.txt","Fast Food":"3 Fast Food.txt","South Indian":"4 "
    "South Indian.txt","Starters":"5 Starters.txt","Main Course":"6 "
    "Main Course.txt","Dessert":"7 Dessert.txt"}
...
root.title("Welcome to Ghar Ka Khana")
root.wm_iconbitmap("burger.ico")

style_button = ttk.Style()
style_button.configure("TButton",font=("arial",10,"bold"),bg="lightgreen")

title_frame = Frame(root,bd=8,bg="yellow",relief=GROOVE)
title_frame.pack(side=TOP,fill="x")

title_label = Label(title_frame,text="Ghar Ka Khana",font=("times new roman",20,"bold" ),bg = "yellow",fg="red",pady=5)
title_label.pack()

custom_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),bd=2,bg="lightblue")
custom_frame.pack(side=TOP,fill="x")
customer_name_label = Label(custom_frame,text="Name : ",font=("times new roman", 15, "bold"),bg="lightblue",fg="gray")
customer_name_label.grid(row=0,column=0)

customerName = StringVar()
customerName.set("")
customer_name_entry = Entry(custom_frame,width=20,font=("times new roman", 15, "bold"),bd=2,textvariable=customerName)
customer_name_entry.grid(row=0,column=1,padx=20)


customer_contact_label = Label(custom_frame, text="Contact",
                    font=("arial", 15, "bold"),bg = "lightblue", fg="gray")
customer_contact_label.grid(row = 0, column = 2)

customerContact = StringVar()
customerContact.set("")
customer_contact_entry = Entry(custom_frame,width=20,font="arial 15",bd=2,
